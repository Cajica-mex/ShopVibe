...
class TestTicket006(unittest.TestCase):
    def test_deduplication(self):
        script_path = 'src/deduplicate_orders.py'
        self.assertTrue(os.path.exists(script_path), f"Error TICKET-JR-006: Debes crear e implementar el script '{script_path}'.")
        ...
        self.assertEqual(total_rows, unique_ids, f"Hay duplicados en silver_orders ({total_rows} filas vs {unique_ids} IDs únicos). Asegúrate de ejecutar src/deduplicate_orders.py para deduplicar.")
